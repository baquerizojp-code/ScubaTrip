        ...
        <div className="absolute bottom-0 w-full z-10">
          <div className="container mx-auto px-6 sm:px-10 pb-12 md:pb-24">
            <div className="max-w-4xl animate-in fade-in slide-in-from-bottom-8 duration-1000">
              ...
              {/* AUDIT FIX: Replaced text-slate-200 / text-slate-400 with text-ocean-200 / text-ocean-300 */}
              <p className="text-xl md:text-2xl text-ocean-200 font-light max-w-2xl flex items-center gap-2 bg-black/20 backdrop-blur-sm w-fit px-4 py-2 rounded-xl border border-white/10">
                <MapPin className="w-6 h-6 text-secondary" />
                {trip.dive_site} <span className="text-ocean-300 mx-2">•</span> <span className="opacity-80 text-lg">{trip.departure_point}</span>
              </p>
            </div>
          </div>
        </div>
